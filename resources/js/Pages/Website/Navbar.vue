...
<template>
    <nav
        id="default-nav"
        class="bg-emerald-50 w-full dark:border-gray-600"
        :class="className"
    >
        <div
        ...
        >
            ...
            >
                <svg
                    class="w-8 h-8 fill-emerald-700"
                ...
                <span
                    class="text-emerald-800 self-center text-base font-black font-['Lexend_Deca'] whitespace-nowrap"
                >
                    Nepano
                </span>
            </Link>
