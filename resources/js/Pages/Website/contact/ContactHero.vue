            ...
            >
                ...
                >
                    ...
                    <p
                        ...
                        data-aos="fade-down"
                    >
                        Caso tenha alguma dúvida ou sugestão, fique à vontade
                        para entrar em contacto connosco.
                    </p>
                </div>
                <div class="lg:col-span-6 justify-center hidden lg:flex">
                    <div
                        class="shadow-2xl shadow-emerald-300/40 drop-shadow-2xl rounded-full w-72 h-72 p-8 flex items-center justity-center"
                    >
                        <svg
                            data-name="Layer 1"
