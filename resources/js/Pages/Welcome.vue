...
<template>
    ...
    >
        <div
            class="animate-spin rounded-full h-32 w-32 border-t-8 border-b border-emerald-600"
        ></div>
        <div class="absolute">
            <svg
                class="w-24 h-24 fill-emerald-950"
        ...
        >
            <div>
                <div class="flex flex-row justify-center">
                    <h5
                        class="bg-gradient-to-r from-teal-600 to-emerald-800 text-3xl rounded-md my-4 w-fit lg:rounded-tl-3xl lg:rounded-br-3xl font-['Black_Ravens'] tracking-widest font-light px-3 text-white"
                    >
