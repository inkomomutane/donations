        ...
        <template v-slot:content>
            <div class="mx-auto">
                ...
                >
                    <!-- Start Card List -->
                    <div
                        class="relative w-full h-52 bg-cover bg-center group rounded-lg overflow-hidden mt-4 shadow-lg transition duration-300 ease-in-out"
                    ...
                    >
                        ...
                        >
                            <div class="px-4 font-['Anta']">
                                <div
                                    class="text-white flex space-x-2 items-center"
                                >
                                    <div
                                ...
                                <h3 class="text-white text-4xl mt-2 font-bold">
                                    {{
                                        numberMoneyFormat(totalRaised ?? 0) +
                                        " MZN"
                                    }}
                                </h3>
                            </div>
                    ...
                    >
                        ...
                        >
                            <div class="px-4 font-['Anta']">
                                ...
                                <h3 class="text-white text-4xl mt-2 font-bold">
                                    {{
                                        numberMoneyFormat(totalToRaise ?? 0) +
                                        " MZN"
                                    }}
                                </h3>
                            </div>
